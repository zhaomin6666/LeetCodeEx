...
public class LEET5339 {
    public static void main(String[] args) {
        LEET5339 l5344 = new LEET5339();
        System.out.println(l5344.new Solution().maxSumBST(CommonFunctions.stringToTreeNode("[1,4,3,2,4,2,5,null,null,null,null,null,null,4,6]")));
        System.out.println(l5344.new Solution().maxSumBST(CommonFunctions.stringToTreeNode("[4,3,null,1,2]")));
        System.out.println(l5344.new Solution().maxSumBST(CommonFunctions.stringToTreeNode("[-4,-2,-5]")));
        System.out.println(l5344.new Solution().maxSumBST(CommonFunctions.stringToTreeNode("[2,1,3]")));
        System.out.println(l5344.new Solution().maxSumBST(CommonFunctions.stringToTreeNode("[5,4,8,3,null,6,3]")));
        System.out.println(l5344.new Solution().maxSumBST(CommonFunctions.stringToTreeNode("[8,9,8,null,9,null,1,null,null,-3,5,null,-2,null,6]")));
        System.out.println(l5344.new Solution().maxSumBST(CommonFunctions.stringToTreeNode("[0,9,-8,6,-6,9,3,-5,1,7,1,0,null,-6,null,-4,1,null,3,2,null,null,null,null,null,null,null,null,null,null,null,4,null,10,8,null,null,null,null,1,13,-1,2,10,16,null,null,null,6,null,12,null,17]")));
        System.out.println(l5344.new Solution().maxSumBST(CommonFunctions.stringToTreeNode("[4,0,2,-20,7,11,null,7,2,null,5,-3,-13,11,-9,4,-20,-9,9,null,16,8,-17,-11,-3,null,null,-18,-15,-20,-3,20,null,4,20,null,null,-2,null,null,2,-3,2,null,14,null,-1,null,11,12,5,null,null,null,-4,-7,6,12,23,null,null,null,12,9,8,9,-5,-6,null,null,null,-15,null,-9,null,null,-10,-6,5,-8,-6,5,7,10,13,21,24,null,null,null,null,null,null,null,null,null,null,null,5,null,null,null,null,null,null,null,null,null,-3,null,null,null,2,null,null,null,8,null,null,null,14,null,22,null,26]")));
    }
