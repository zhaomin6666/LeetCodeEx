...
public class LEET1095 {
    public static void main(String[] args) {
        LEET1095 l1095 = new LEET1095();
        MountainArrayImpl mountainArray1 = new MountainArrayImpl(new int[]{1, 2, 3, 4, 5, 3, 1});
        System.out.println(l1095.new Solution().findInMountainArray(3, mountainArray1));
        MountainArrayImpl mountainArray2 = new MountainArrayImpl(new int[]{0, 1, 2, 4, 2, 1});
        System.out.println(l1095.new Solution().findInMountainArray(3, mountainArray2));
        MountainArrayImpl mountainArray3 = new MountainArrayImpl(new int[]{0, 1, 0});
        System.out.println(l1095.new Solution().findInMountainArray(3, mountainArray3));
    }
