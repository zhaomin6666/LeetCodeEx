...
public class LEET123 {
	public static void main(String[] args) {
		...
		int[] prices7 = { 2, 1, 4 };
		System.out.println(l0123.new Solution().maxProfit(prices1));
		System.out.println(l0123.new Solution().maxProfit(prices2));
		System.out.println(l0123.new Solution().maxProfit(prices3));
		System.out.println(l0123.new Solution().maxProfit(prices4));
		System.out.println(l0123.new Solution().maxProfit(prices5));
		System.out.println(l0123.new Solution().maxProfit(prices6));
		System.out.println(l0123.new Solution().maxProfit(prices7));
	}
