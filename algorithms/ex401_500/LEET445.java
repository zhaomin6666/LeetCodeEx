...
public class LEET445 {
	...
	class Solution {
		public ListNode<Integer> addTwoNumbers(ListNode<Integer> l1, ListNode<Integer> l2) {
			...
			l2 = reverse(l2);
			// 各位相加
			ListNode<Integer> addResult = addTwoNumbersReverse(l1, l2);
			return reverse(addResult);
		}

		public ListNode<Integer> reverse(ListNode<Integer> cur) {
		...
		private ListNode<Integer> addTwoNumbersReverse(ListNode<Integer> l1, ListNode<Integer> l2) {
	...
	class Solution2 {
		public ListNode<Integer> addTwoNumbers(ListNode<Integer> l1, ListNode<Integer> l2) {
			...
			while (!stack1.isEmpty() || !stack2.isEmpty()) {
				...
				int sum = carry + x + y;
				carry = sum / 10;
				ListNode<Integer> temp = new ListNode<>(sum % 10);
				temp.next = curr;
				curr = temp;
			}
			if (carry > 0) {
				ListNode<Integer> temp = new ListNode<>(carry);
				temp.next = curr;
				curr = temp;
			}
			return curr;
		...
		private Stack<Integer> listToStack(ListNode<Integer> node) {
