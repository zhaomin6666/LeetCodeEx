...
public class LEET466 {
    public static void main(String[] args) {
        LEET466 l460 = new LEET466();
        System.out.println(l460.new Solution().getMaxRepetitions("acb", 4, "ab", 2));

    }

    /**
     * 判断几个s1形成的字符串可以构成n个S2的循环体
     * <p>
     * 如S1:acb acb acb acb S2:ab ab
     * 那么k=2个s1可以构成一个S2然后用n1/k
     */
    class Solution {
