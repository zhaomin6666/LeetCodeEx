...
public class LEET054 {
    public static void main(String[] args) {
        ...
        int[][] matrix3 = {{1, 2, 3}};
        System.out.println(l054.new Solution().spiralOrder(matrix1));
        System.out.println(l054.new Solution().spiralOrder(matrix2));
        System.out.println(l054.new Solution().spiralOrder(matrix3));
    }
