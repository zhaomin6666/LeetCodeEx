...
public class LCP50 {
	...
	public static void main(String[] args) {
		System.out.println(new Solution().giveGem(new int[]{3, 1, 2}, new int[][]{{0, 2}, {2, 1}, {2, 0}}));
		System.out.println(new Solution().giveGem(new int[]{100, 0, 50, 100}, new int[][]{{0, 2}, {0, 1}, {3, 0}, {3, 0}}));
	}
